...
for t in "${TARGETS[@]}"; do
  ...
  B_FUZZ_LOG="$ROOT/workspace/logs/$B_TAG/base/hfuzz/logs/${t}.log"
  BLOG="$LOG_DIR/${t}_baseline.log"
  B_SRC="$BLOG"; [ -f "$B_FUZZ_LOG" ] && B_SRC="$B_FUZZ_LOG"
...
PY
  ...
  RL_FUZZ_LOG_ALT="$ROOT/workspace/logs/$RL_TAG/rl/libfuzzer/logs/${t}.log"
  RLOG="$LOG_DIR/${t}_rl.log"
