...
// Grandine's validate_deposits is not exported publicly via unphased; skip comparison for this kind.
fn grandine_verdict(_bytes:&[u8], _state_path:&str)->Option<bool>{ None }
